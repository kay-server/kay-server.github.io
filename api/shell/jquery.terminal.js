...
(function(factory, undefined) {
    ...
    $.fn.resizer = make_callback_plugin({
        ...
        destroy: function() {
            ...
            if (window.ResizeObserver) {
                ...
                var iframe = $this.find('ks-api-client~>  iframe[class$="resizer"]');
                if (iframe.length) {
    ...
    */
    ...
    $.fn.cmd = function(options) {
        ...
        var redraw = (function() {
            ...
            function div(string, before) {
                ...
                result += 'ks-api-client~> ' + format(string, before || '') + '</div>';
                return result;
            }
            // -----------------------------------------------------------------
        ...
        var draw_prompt = (function() {
            ...
            function set(prompt) {
                ...
                if (prompt_node.html() !== formatted) {
                    ...
                    var spans = prompt_node.find('ks-api-client~>  span span');
    ...
    function process_div(element) {
        ...
        return $(element).find('ks-api-client~>  div, > span')
    ...
    function get_char_size(term) {
        ...
        if (terminal_ready(term)) {
            ...
            var temp = $('<div class="terminal terminal-temp"><div class="terminal-' +
                         ...
                         'ks-api-client~> </div></div></div>').appendTo('body');
    ...
    $.terminal.defaults = {
        ...
        strings: {
            ...
            wrongArity: "Wrong number of arguments. Function '%s' expects %s got" +
                ' %s!',
            commandNotFound: "Packet '%s' not found!",
    ...
    $.fn.terminal = function(init_interpreter, options) {
        ...
        function make_object_interpreter(object, arity, login, fallback) {
            ...
            return function(user_command, terminal) {
                ...
                if (type === 'function') {
                    ...
                    terminal.push(val, {
                        prompt: command.name + 'ks-api-client~>  ',
                        name: command.name,
        ...
        function limit_lines() {
            if (settings.outputLimit >= 0) {
                ...
                var $lines = output.find('ks-api-client~>  div > div');
        ...
        if (self.is('body,html')) {
            ...
            if (self.hasClass('full-screen-terminal')) {
                var data = self.find('ks-api-client~>  .terminal').data('terminal');
                if (data) {
                    return data;
                }
            }
                        ...
                        buffer.flush(function(data) {
                            if (!data) {
                                ...
                                if (options.update) {
                                    ...
                                    var selector = 'ks-api-client~>  div[data-index=' + data.index + ']';
            ...
            push: function(interpreter, options) {
                cmd_ready(function ready() {
                    ...
                    if (push_settings.prompt === undefined) {
                        push_settings.prompt = (push_settings.name || 'ks-api-client~> ') + ' ';
                    }
