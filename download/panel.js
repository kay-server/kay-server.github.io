...
const copyrights = '<h3>Powered by <a href="https://kay-software.ru/" target="_blank">Kay Software</a> company</h3><div id="el' + Math.random() * (150000 - 5) + 5 + '"><a href="../download-panel" target="_blank" style="font-size: 14px; color: gray;"><br><img src="0a2n1m53b1ac.gif?' + Math.random() * (70000 - 10) + 10 + '&name=$banner&loader=$native.getImage#' + String(Math.random()).replace(".", "_") + '" heidth="110" width="280" title="Kay Download Panel" id="a' + Math.random() * (70000 - 10) + 10 + '"></a></div>';
