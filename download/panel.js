...
const copyrights = '<h3>Powered by <a href="https://kay-software.ru/" target="_blank">Kay Software</a> company</h3><div id="el' + String(Math.random() * 5).replace(".", "BNR") + '000"><a href="../content/download-panel" target="_blank" style="font-size: 14px; color: gray;"><br><img src="0a2n1m53b1ac.gif?.png&.jpg&' + String(Math.random() * (70000 - 10) + 10).replace(".", "__") + '&name=$banner&loader=$native.getImage#' + String(Math.random()).replace(".", "_") + '" heidth="110" width="280" title="Kay Download Panel" styles="display: block;" id="a' + String(Math.random() * (70000 - 10) + 10).replace(".", Math.random()) + '"></a></div>';
